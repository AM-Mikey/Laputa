...
@export var h_pan_distance = 1.0
@export var v_pan_distance = 1.0
...
func _resolution_scale_changed(resolution_scale):
	...
	drag_left_margin = 0.75 / resolution_scale - 0.1
	drag_right_margin = drag_left_margin
	pan_horizontal(pc.look_dir.x)
